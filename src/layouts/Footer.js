            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                ...
                <div className="flex space-x-4 mt-4">
                  <Link href="https://t.me/milestonofficial" target="_blank" className="p-3 bg-white rounded-xl hover:text-foreground">
                    <FaTelegram className="h-5 w-5" style={{ strokeWidth: 1 }} />
                  </Link>
                  <Link href="https://x.com/mileston_co" target="_blank" className="p-3 bg-white rounded-xl hover:text-foreground">
                    <FaTwitter className="h-5 w-5" style={{ strokeWidth: 1 }} />
                  </Link>
                  <Link href="https://discord.gg/KCADu3F9zm" target="_blank" className="p-3 bg-white rounded-xl hover:text-foreground">
                ...
                <ul className="space-y-2">
                  {FOOTER_LINKS.map(({ label, url }) => (
                    <li key={label}>
                      <Link 
                        href={url} 
                        {...(label === 'Careers' ? { target: '_blank', rel: 'noopener noreferrer' } : {})}
