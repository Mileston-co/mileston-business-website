...
function Analytics() {
    ...
    return (
        <section className="grid items-start gap-3 section-container lg:grid-cols-3">
            <Feature
                title={'Low Fees'}
                description={
                    'Accept business payments from around the world with just 0.4% transaction fee.'
                }
            >
            ...
            >
                <ScrollTriggeredAnimation>
                    ...
                    {/* <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex w-full gap-5 p-5 bg-white rounded-2xl'>
            ...
            >
                <ScrollTriggeredAnimation>
                    <div className="flex flex-col w-full gap-6 p-5 bg-white rounded-2xl">
                        <Image
                            src={VolatilityProtection}
                            alt=""
                            className="object-contain h-[9.5em]"
                        />
