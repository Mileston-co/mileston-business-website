            ...
            <div className="col-span-4 py-16">
              <div className="space-y-6">
                ...
                <p className="text-gray-400">
                  Send and receive borderless stablecoin transactions worldwide with ease and security
                </p>
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gray-100 rounded-xl">
                    ...
                    <div className="text-sm text-gray-600">Instant Transfers</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-600">{notification.from}</div>
                        <div className="text-xs text-gray-400">{notification.type}</div>
                      </div>
                    </div>
                    <div className="text-sm font-semibold text-gray-600">{notification.amount}</div>
                  </div>
                </div>
              ))}
            </div>
              ...
              <div className="relative transition-all duration-300 group hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="p-4 pt-8 bg-[#1E1E1E] text-white rounded-xl font-mono text-sm overflow-x-auto">
                  <div className="opacity-70">
                    ...
                    <span className="text-green-400">&apos;@mileston/sdk&apos;</span>
                  </div>
              ...
              <div className="absolute space-y-3 wallet-card">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-white rounded-xl">
                    <div className="flex items-center justify-center w-10 h-10 bg-[#3B99FC]/10 rounded-full">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M6.36 8.65c3.12-3.12 8.16-3.12 11.28 0l.37.37c.16.16.16.41 0 .57l-1.27 1.27c-.08.08-.2.08-.28 0l-.51-.51c-2.18-2.18-5.72-2.18-7.9 0l-.55.55c-.08.08-.2.08-.28 0L6.15 9.83c-.16-.16-.16-.41 0-.57l.21-.21zm13.96 2.68l1.13 1.13c.16.16.16.41 0 .57l-5.11 5.11c-.16.16-.41.16-.57 0l-3.63-3.63c-.04-.04-.1-.04-.14 0l-3.63 3.63c-.16.16-.41.16-.57 0l-5.11-5.11c-.16-.16-.16-.41 0-.57l1.13-1.13c.16-.16.41-.16.57 0l3.63 3.63c.04.04.1.04.14 0l3.63-3.63c.16-.16.41-.16.57 0l3.63 3.63c.04.04.1.04.14 0l3.63-3.63c.16-.16.41-.16.57 0z" fill="#3B99FC"/>
                      </svg>
                    </div>
                ...
                <div className="wallet-option">
                  <div className="flex items-center gap-3 p-4 bg-white rounded-xl">
                    ...
                    <span className="font-medium text-gray-900">Trust Wallet</span>
                  </div>
                </div>
                ...
                <div className="wallet-option">
                  <div className="flex items-center gap-3 p-4 bg-white rounded-xl">
                    ...
                    <span className="font-medium text-gray-900">Binance Pay</span>
                  </div>
                </div>
              </div>
            </div>
