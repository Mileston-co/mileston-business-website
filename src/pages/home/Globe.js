...
export function Globe() {
  ...
  return (
    <div className="relative flex flex-row items-center justify-center w-full h-screen py-20 bg-white md:h-auto dark:bg-black">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        <div className="absolute z-10 w-full -bottom-20 h-72 md:h-full">
