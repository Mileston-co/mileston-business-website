...
const testimonials = [
  {
    ...
    rating: 5,
    review:
      "Mileston has transformed the way we accept payments. Fast, secure, and incredibly low fees!",
  },
  {
    initials: "AS",
    name: "Alice Smith",
    ...
    rating: 5,
    review:
      "Integrating Mileston into my workflow was seamless. No more high fees, just smooth transactions!",
  },
  {
    initials: "MR",
    name: "Michael Ross",
    ...
    rating: 5,
    review:
      "Crypto payments made easy! Mileston's API integration was a game changer for our business.",
  },
];
