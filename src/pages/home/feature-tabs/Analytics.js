...
const Analytics = () => {
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div
        ref={chartRef}
        className="relative h-[400px] bg-white rounded-xl p-6"
      >
      ...
      >
        <div className="p-6 bg-gray-50 rounded-xl">
          ...
          <p className="text-sm text-gray-600">Track transactions and user activity in real-time with detailed analytics</p>
        </div>
        <div className="p-6 bg-gray-50 rounded-xl">
          <h4 className="mb-2 text-lg font-medium">Smart Insights</h4>
          <p className="text-sm text-gray-600">AI-powered insights to help you optimize your payment flows</p>
        </div>
      </div>
    </div>
  );
