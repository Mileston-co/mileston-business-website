      ...
      >
        ...
        <div className="p-4 bg-gray-900 rounded-lg">
          <code className="font-mono text-sm text-gray-300">
            <span className="text-blue-400">const</span> paymentLink = <span className="text-green-400">await</span> mileston.createPaymentLink(&#123;
            <br />
            &nbsp;&nbsp;amount: <span className="text-orange-400">1000</span>,
            <br />
            &nbsp;&nbsp;currency: <span className="text-yellow-400">&apos;USD&apos;</span>,
            <br />
            &nbsp;&nbsp;description: <span className="text-yellow-400">&apos;Premium Subscription&apos;</span>
            <br />
            &#125;);
          </code>
        </div>
